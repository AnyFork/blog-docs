...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    var _a;
    const categoryMap = u("category");
    const route = useRoute();
    const router = useRouter();
    console.log(route);
    const pages = reactive({
      pageTotal: ((_a = categoryMap.value.currentItems) == null ? void 0 : _a.length) || 0,
      pageNumber: 1,
      pageSize: 10
    });
    const blogData = computed(() => {
      var _a2;
      return (_a2 = categoryMap.value.currentItems) == null ? void 0 : _a2.slice((pages.pageNumber - 1) * pages.pageSize, pages.pageNumber * pages.pageSize);
    });
    const getBack = (value) => {
          ...
          createBaseVNode("main", _hoisted_1, [
            createBaseVNode("div", _hoisted_2, [
              ...
              createBaseVNode("div", _hoisted_3, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(categoryMap).map, ({ items, path }, name) => {
...
var Category = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "Category.vue"]]);
