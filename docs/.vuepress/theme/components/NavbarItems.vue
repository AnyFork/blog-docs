...
import type { NavbarGroup, NavbarItem, ResolvedNavbarItem } from '@vuepress/theme-default'
...
const navbarLinks: any = computed(() => [...navbarConfig.value, ...navbarSelectLanguage.value, ...navbarRepo.value])
</script>
