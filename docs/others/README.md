...
![](\docs\img\image-20191229173422328.png)
...
![](\docs\img\image-20191229173455149.png)
...
![](\docs\img\image-20191229173518926.png)
...
![](\docs\img\image-20191229173539838.png)
...
![](\docs\img\image-20191229173554296.png)
...
<img src="\docs\img\正方形不是长方形改进.png" style="zoom:80%;" />
...
<img src="\docs\img\依赖倒转原则.png" style="zoom:80%;" />
...
<img src="/docs/img/依赖倒转原则改进.png" alt="image-20191229173554296" style="zoom:70%;" />
...
<img src="/docs/img/迪米特法则.png" alt="image-20191229173554296" style="zoom:80%;" />
...
<img src="/docs/img/合成复用原则.png" alt="image-20191229173554296" style="zoom:80%;" />

从上面类图我们可以看到使用继承复用产生了很多子类，如果现在又有新的动力源或者新的颜色的话，就需要再定义新的类。我们试着将继承复用改为聚合复用看一下。

<img src="/docs/img/合成复用原则1.png" alt="image-20191229173554296" style="zoom:80%;" />
...
<img src="/docs/img/工厂设计模式引入.png" style="zoom:80%;" />
...
<img src="/docs/img/简单工厂模式.png" style="zoom:70%;" />
...
<img src="/docs/img/工厂方法模式.png" style="zoom:70%;" />
...
<img src="/docs/img/image-20200401214509176.png" style="zoom:67%;" />

<img src="/docs/img/image-20200401222951963.png" style="zoom:67%;" />
...
<img src="/docs/img/抽象工厂模式.png" style="zoom:67%;" />
...
<img src="/docs/img/JDK源码解析.png" style="zoom:75%;" />
...
<img src="\docs\img\原型模式1.png" style="zoom:80%;" />
...
<img src="\docs\img\原型模式2.png" style="zoom:80%;" />
...
<img src="\docs\img\原型模式3.png" style="zoom:80%;" />
...
<img src="/docs/img/image-20200413225341516.png" style="zoom:60%;" />
...
<img src="/docs/img/建造者模式.png" style="zoom:80%;" />
...
<img src="/docs/img/建造者模式1.png" style="zoom:80%;" />
...
<img src="\docs\img\静态代理.png" style="zoom:80%;" />
...
<img src="/docs/img/适配器模式.png" style="zoom:80%;" />
...
<img src="\docs\img\对象适配器模式.png" style="zoom:80%;" />
...
<img src="/docs/img/装饰者模式-使用前.png" style="zoom:80%;" />
...
<img src="/docs/img/装饰者模式.png" style="zoom:75%;" />
...
<img src="\docs\img\装饰者模式-jdk源码.png" style="zoom:80%;" />
...
![](\docs\img\image-20200207194617620.png)
...
<img src="\docs\img\桥接模式.png" style="zoom:80%;" />
...
<img src="/docs/img/外观模式.png" style="zoom:80%;" />
...
<img src="/docs/img/image-20200207234545691.png" style="zoom:60%;" />

RequestFacade 类就使用了外观模式。先看结构图：

<img src="/docs/img/外观模式-jdk源码解析.png" style="zoom:70%;" />
...
<img src="/docs/img/image-20200208180417291.png" style="zoom:60%;" />
...
<img src="/docs/img/image-20200208182322313.png" style="zoom:80%;" />

要实现该案例，我们先画出类图：

<img src="/docs/img/组合模式.png" style="zoom:80%;" />
...
- 安全组合模式
  ...
  <img src="/docs/img/组合模式-安全性.png" style="zoom:80%;" />
...
<img src="/docs/img/俄罗斯方块.jpeg" style="zoom:60%;" />

**先来看类图：**

<img src="/docs/img/享元模式.png" style="zoom:80%;" />
...
<img src="/docs/img/image-20200208212930857.png" style="zoom:80%;" />
...
<img src="/docs/img/模板方法模式.png" style="zoom:80%;" />
...
<img src="/docs/img/image-20200210143039168.png" style="zoom:80%;" />

作为一个程序猿，开发需要选择一款开发工具，当然可以进行代码开发的工具有很多，可以选择 Idea 进行开发，也可以使用 eclipse 进行开发，也可以使用其他的一些开发工具。

<img src="/docs/img/image-20200210144457478.png" style="zoom:70%;" />
...
<img src="/docs/img/策略模式.png" style="zoom:80%;" />
...
<img src="/docs/img/image-20200211130313251.png" style="zoom:60%;" />
...
<img src="/docs/img/命令模式.png" style="zoom:75%;" />
...
<img src="/docs/img/责任链模式.png" style="zoom:80%;" />
...
<img src="/docs/img/状态模式前.png" style="zoom:80%;" />
...
<img src="/docs/img/状态模式.png" style="zoom:70%;" />
...
<img src="/docs/img/观察者模式.png" style="zoom:80%;" />
...
<img src="/docs/img/image-20200214110924010.png" style="zoom:60%;" />
...
<img src="/docs/img/中介者模式.png" style="zoom:70%;" />
...
<img src="/docs/img/迭代器模式.png" style="zoom:90%;" />
...
<img src="/docs/img/image-20200214215446638.png" style="zoom:70%;" />
...
<img src="/docs/img/image-20200426233931693.png" style="zoom:67%;" />
...
<img src="/docs/img/白箱备忘录模式.png" style="zoom:80%;" />
...
<img src="/docs/img/黑箱备忘录模式.png" style="zoom:70%;" />
...
<img src="/docs/img/image-20200215220322641.png" style="zoom:60%;" />
...
<img src="/docs/img/image-20200215225227616.png" style="zoom:50%;" />
...
<img src="/docs/img/解释器模式.png" style="zoom:80%;" />
...
- 编写配置文件。在类路径下编写一个名为 ApplicationContext.xml 的配置文件
  ...
  <img src="/docs/img/image-20200429165544151.png" style="zoom:60%;" />
...
<img src="/docs/img/image-20200429111324770.png" style="zoom:40%;" />
...
<img src="/docs/img/image-20200429185050396.png" style="zoom:60%;" />
...
<img src="/docs/img/image-20200430220155371.png" style="zoom:60%;" />
...
<img src="/docs/img/image-20200429204239868.png" style="zoom:60%;" />
...
<img src="/docs/img/image-20200429204700956.png" style="zoom:60%;" />
...
<img src="/docs/img/image-20200429211132185.png" style="zoom:60%;" />
